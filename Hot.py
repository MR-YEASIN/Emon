...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.001)
sys.stdout.write('\x1b[1;35m\x1b]2; KD- EMON \x07')
...
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘈𝘜𝘛𝘏𝘖𝘙      \033[1;97m  :  \033[34;1m𝐒𝐑-𝐄𝐌𝐎𝐍          \033[38;5;46m \033[33;1m
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘎𝘐𝘛𝘏𝘜𝘉        \033[1;97m:  \033[34;1m𝐓𝐞𝐚𝐦-𝐋𝐂𝐒-99    \033[38;5;46m    \033[33;1m
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘞𝘏𝘈𝘛𝘚𝘈𝘗𝘗   \033[1;97m   :  \033[34;1m01865941765       \033[38;5;46m
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘗𝘖𝘞𝘌𝘙       \033[1;97m  :  \033[34;1m𝐒𝐑-𝐄𝐌𝐎𝐍        \033[38;5;46m
...
def Main():
	...
	if opt in ["C","3"]:
		...
		fb()
	if opt in ["D","4"]:
		os.system('xdg-open https://wa.me/+8801856209871');time.sleep(1)
		group()
	if opt in ["0","0"]:
		exit()
...
def admin():
	...
	if bal =='1':
		...
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/profile.php?id=61550602840196');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/Team-LCS-99');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/Team-LCS-99/Emon/blob/main/Approved.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
